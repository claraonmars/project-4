...
class MerchantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create merchant" do
    assert_difference('Merchant.count') do
      post merchants_url, params: { merchant: { category: @merchant.category, reference: @merchant.reference } }
    end
  ...
  test "should update merchant" do
    patch merchant_url(@merchant), params: { merchant: { category: @merchant.category, reference: @merchant.reference } }
