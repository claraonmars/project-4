...
class SavingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create saving" do
    assert_difference('Saving.count') do
      post savings_url, params: { saving: { amount: @saving.amount, balance: @saving.balance, type: @saving.type } }
    end
  ...
  test "should update saving" do
    patch saving_url(@saving), params: { saving: { amount: @saving.amount, balance: @saving.balance, type: @saving.type } }
